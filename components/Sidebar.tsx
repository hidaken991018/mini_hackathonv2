...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col w-64 h-screen sticky top-0 border-r border-white/40 p-6">
      <div className="mb-10">
        <h1 className="text-3xl font-black tracking-tighter text-slate-900 flex items-center gap-2">
          <span className="w-8 h-8 bg-rose-500 rounded-xl flex items-center justify-center text-white text-lg">s</span>
          syufy
        </h1>
      </div>
